...
mkudffs --blocksize=4096 --media-type=hd --utf8 /dev/zram0 || _fatal "mkfs failed"
mkudffs --blocksize=4096 --media-type=hd --utf8 /dev/zram1 || _fatal "mkfs failed"
...
FSTYP=udf
UDF_MKFS_OPTIONS="--blocksize=4096 --media-type=hd --utf8"
EOF
fi
